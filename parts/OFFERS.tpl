	...
	<div class="offers_wrapper">
		<a name="landing"><div class="offers_landing_page">
			<div class="offers_description">
				<p class="offers_header">Тип услуги</p>
			...
			<div class="offers_prices">
				<p class="offers_header">Цена</p>
				<span>4900₽</span>
				<p class="offers_header">Срок выполнения</p>
				7 дней
			</div>
		</div></a>
		<a name="business"><div class="offers_business_site">
			<div class="offers_description">
				<p class="offers_header">Тип услуги</p>
		...
		<a name="company"><div class="offers_company_site">
			<div class="offers_description">
				<p class="offers_header">Тип услуги</p>
